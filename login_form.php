			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to the Student Self-Assessment System", { header: 'Access Granted' });
									var delay = 1000;
			...
			<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign in as a Teacher" id="signin_lecturer" onclick="window.location='signup_teacher.php'" name="login" class="btn btn-info" type="submit">I`m a Teacher</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
